...
const noonerize = (numbers) => {
	...
	let num0 = +(numbers[0].toString()[0] + numbers[1].toString().slice(1));
	let num1 = +(numbers[1].toString()[0] + numbers[0].toString().slice(1));
	return num1 > num0 ? num1 - num0 : num0 - num1;
}
console.log(noonerize([456, 123456]))